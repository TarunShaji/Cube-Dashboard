...
/** Expand a 2-digit year to a 4-digit year (pivot: ≥70 → 19xx, <70 → 20xx, but never more than 5 years in the past) */
function expandYear(yy) {
    ...
    return candidate < currentYear - 5 ? currentYear : candidate
}
